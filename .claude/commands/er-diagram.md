...
- No incluyas explicaciones adicionales ni generes artefactos fuera del formato pedido.
- Asegúrate de verificar y utilizar el MCP del formato seleccionado en caso de estar disponible. En caso contrario, genera el diagrama desde cero siguiendo las mejores prácticas.
